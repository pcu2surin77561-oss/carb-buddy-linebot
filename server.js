        ...
        if (text === 'ดูสมุดพก') {
            ...
            try {
                ...
                const prompt = `
                  ...
                  1. 🩺 สรุปผลสุขภาพ
                  - หากมีข้อมูลผลแล็บ ให้สรุปเฉพาะค่าที่สำคัญ เช่น:น้ำตาล (FBS / HbA1c), ไขมัน (LDL, HDL, TG), ความดัน, ไต (Cr, eGFR)
                  - อธิบายแต่ละค่าแบบเข้าใจง่าย โดยระบุ:
                    • ค่าที่ได้
                    • สถานะ: ปกติ / ควรระวัง / สูง / ต่ำ
                    • ความหมายสั้น ๆ
                    - สรุปภาพรวมท้าย “โดยรวมสุขภาพอยู่ในระดับ...” หากไม่มีข้อมูลผลแล็บ:ให้ข้ามส่วนนี้ทั้งหมด
                    ...
                    ตัวอย่าง 
                     ...
                     - HbA1c: 7.5% → สูง 
                     หมายถึง น้ำตาลสะสมเกินเป้าหมาย ควบคุมเบาหวานยังไม่ดี

                    - LDL: 160 mg/dL → สูง
                      ไขมันไม่ดีสูง เสี่ยงโรคหัวใจ

                    - eGFR: 85 → ปกติ
                      การทำงานของไตยังดี

                โดยรวมสุขภาพ: ควรระวัง (ควบคุมน้ำตาลและไขมันเพิ่มเติม)
