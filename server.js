    ...
    if (event.message.type === 'text') {
        ...
        if (text === 'ดูสมุดพก') {
            ...
            try {
                ...
                คุณคือผู้ช่วยวิเคราะห์สุขภาพสำหรับผู้ป่วยเบาหวาน
                ต้องใช้เฉพาะ “ข้อมูลที่ผู้ใช้ให้มาเท่านั้น” ห้ามเดา ห้ามสร้างข้อมูลใหม่

                ========================
                INPUT DATA (ข้อมูลผู้ป่วย)
                ========================
                HbA1c: {{HbA1c}}
                FBS: {{FBS}}
                LDL: {{LDL}}
                ...
                (ถ้าไม่มีค่า ให้เป็นค่าว่าง หรือ null)
                ...
                - แสดงเฉพาะค่าที่ “มีข้อมูลจริงเท่านั้น”
                - ห้ามเดา / ห้ามเติมค่า / ห้ามใช้ค่าจากตัวอย่าง
                - หากค่าหนึ่ง “ไม่มีข้อมูล” → ข้ามทันที

                สำหรับแต่ละค่า ให้แสดง:
                - ชื่อค่า + ค่าที่ได้
                - สถานะ: ปกติ / ควรระวัง / สูง / ต่ำ
                - ความหมายสั้น ๆ
                ...
                สรุปท้าย:
                - “โดยรวมสุขภาพอยู่ในระดับ...”

                หากไม่มีข้อมูลผลแล็บเลย:
                  ให้ข้ามส่วนนี้ทั้งหมด
                  
                - ห้ามแสดงหัวข้อ “🩺 สรุปผลสุขภาพ”
                ...
                - ห้ามสร้างตัวเลขเอง
                - ห้ามคาดเดา
                - ใช้เฉพาะค่าที่อยู่ใน INPUT DATA เท่านั้น
                - Output ต้องเป็นภาษาไทย เข้าใจง่าย
                - ตอบตาม format เท่านั้น ห้ามเพิ่มเนื้อหาอื่น
                ...
                (แสดงเฉพาะค่าที่มี)
                    ...
                    - ตอบแบบสั้น กระชับ ไม่ใช้ศัพท์แพทย์ซับซ้อน
    ...
    if (event.message.type === 'image') {
        ...
        try {
            ...
            const prompt = `
                ...
                🍽 อาหารที่พบในภาพ:
                - ข้าวสวย: X ทัพพี
                - เมนูอาหาร: ปริมาณโดยประมาณ (ระบุเป็น จาน/ช้อน/กรัม)

                📊 CARB_BREAKDOWN (1 หน่วย = 15g carbohydrate)
                - ข้าวสวย: X
                - อาหารอื่น: X

                📈 ผลต่อระดับน้ำตาล
                - ต่ำ / ปานกลาง / สูง (ประเมินจากปริมาณคาร์บและชนิดอาหาร)

                💡 คำแนะนำผู้ป่วยเบาหวาน
                - ให้คำแนะนำสั้น กระชับ ปรับพฤติกรรมได้จริง
    
                กฎ:
                - ข้าว 1 ทัพพี = 1 คาร์บ
                - อาหารผัด/มีซอส = 0.5–1 คาร์บ (ประเมินตามปริมาณ)
                - เนื้อสัตว์/ไข่ = 0 คาร์บ
                - หลีกเลี่ยงการเดาสุ่ม ให้ประเมินอย่างสมเหตุสมผล
                ...
                🍽 อาหารที่พบในภาพ
            - ข้าวสวย: 2 ทัพพี
            - ผัดกะเพรา: 1 จาน (ประมาณ 150 กรัม)
            - ไข่ดาว: 1 ฟอง
            ...
            💡 คำแนะนำผู้ป่วยเบาหวาน
            - ลดข้าวเหลือ 1–1.5 ทัพพี และเพิ่มผัก จะช่วยควบคุมน้ำตาลได้ดีขึ้น
